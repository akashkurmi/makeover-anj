...
const About = () => {
  return (
    <section className="bg-stone-50 py-20 px-6 md:px-12 border-b border-white/5 relative">
      {/* Brand Header (Consistent with Nav Bars) */}
      <div className="relative flex flex-col items-center justify-center mb-24">
        <Link href={"/"}>
          <h2 className="text-stone-900 text-4xl md:text-6xl font-black uppercase italic tracking-tighter">
            <span className="text-pink-500">Anjali</span> Makeover
          </h2>
        </Link>
        <div className="mt-4 flex items-center space-x-4">
          <span className="h-px w-8 md:w-12 bg-pink-500"></span>
          <span className="text-stone-900 text-[10px] tracking-[0.6em] uppercase font-bold">
            Artistry & Vision
          </span>
          <span className="h-px w-8 md:w-12 bg-pink-500"></span>
        </div>
      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          <div className="w-full lg:w-5/12 relative">
            <div className="relative aspect-[3/4] overflow-hidden rounded-sm border border-stone-400">
              <Image
                src="/anjHome.png"
          ...
          <div className="w-full lg:w-7/12 space-y-8">
            <div className="space-y-4">
              ...
              <h3 className="text-stone-900 text-5xl md:text-7xl font-serif italic tracking-tight">
            ...
            <div className="space-y-6 text-stone-700 text-lg leading-relaxed font-light">
              <p>
                I am <span className="text-stone-900 font-medium">Anjali Gour</span>
                , a Lakmé Academy Certified professional dedicated to the art of
                transformation. Based in{" "}
                <span className="text-stone-900 font-medium">Bangalore</span>, my
              ...
              <div className="bg-stone-100 border border-stone-300 p-6 rounded-sm flex items-start gap-4">
                <MapPin className="text-pink-500 shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="text-stone-900 font-bold uppercase tracking-widest text-sm mb-1">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex gap-4 group">
                  ...
                  />
                  <div>
                    <h5 className="text-stone-900 font-bold text-sm uppercase tracking-wider">
                      {item.title}
                    </h5>
      ...
      {/* <div className="max-w-7xl mx-auto mt-32">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 py-16 border-y border-white/10 bg-stone-100/30">
          <div className="flex flex-col items-center text-center space-y-3">
            <div className="p-4 bg-pink-500/10 rounded-full">
              <Users className="text-pink-500" size={28} />
            </div>
            <div>
              <h4 className="text-stone-900 text-3xl md:text-5xl font-black tracking-tighter">
                500+
              </h4>
              <p className="text-stone-600 text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold mt-1">
                Happy Clients
              </p>
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-stone-600 italic font-serif text-xl md:text-2xl">
      ...
      <div className="max-w-7xl mx-auto space-y-32 mt-32">
        ...
        <div className="bg-stone-100 border border-stone-300 rounded-sm overflow-hidden">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/3 bg-pink-600 p-12 flex flex-col items-center justify-center text-center space-y-4">
              <Plane size={48} className="text-stone-900 animate-pulse" />
              <h4 className="text-stone-900 text-2xl font-black uppercase tracking-tighter">
                Pan India Service
              </h4>
            </div>
            ...
            <div className="md:w-2/3 p-8 md:p-12 space-y-6">
              <h3 className="text-stone-900 text-3xl font-serif italic">
        ...
        <div className="pt-10 text-center space-y-4">
          <h2 className="text-stone-900 text-2xl md:text-4xl font-serif italic">
