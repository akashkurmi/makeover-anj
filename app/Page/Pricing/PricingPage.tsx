...
const PricingPage = () => {
  ...
  return (
    <div className="bg-stone-50 text-stone-900 min-h-screen py-20 px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="mb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-stone-400 pb-2 mb-6 gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-stone-200 text-pink-500 text-sm border border-stone-400 rounded px-3 py-1 outline-none focus:border-pink-500 transition-all cursor-pointer"
                >
                  {locations.map((loc) => (
                ...
                >
                  <div className="flex-1">
                    <div className="flex justify-between items-baseline">
                      <h3 className="text-lg font-medium text-stone-900 group-hover:text-pink-400 transition-colors">
                        {service.name}
                      </h3>
        ...
        <p className="text-center text-stone-600 text-sm italic mt-10">
